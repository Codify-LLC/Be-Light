...
import 'premium_session_locked_model.dart';
export 'premium_session_locked_model.dart';

class PremiumSessionLockedWidget extends StatefulWidget {
  const PremiumSessionLockedWidget({Key? key}) : super(key: key);

  @override
  _PremiumSessionLockedWidgetState createState() =>
      _PremiumSessionLockedWidgetState();
}

class _PremiumSessionLockedWidgetState
    extends State<PremiumSessionLockedWidget> {
  late PremiumSessionLockedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PremiumSessionLockedModel());
  }
