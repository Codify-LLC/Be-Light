...
import 'session_not_dowloaded_model.dart';
export 'session_not_dowloaded_model.dart';

class SessionNotDowloadedWidget extends StatefulWidget {
  const SessionNotDowloadedWidget({Key? key}) : super(key: key);

  @override
  _SessionNotDowloadedWidgetState createState() =>
      _SessionNotDowloadedWidgetState();
}

class _SessionNotDowloadedWidgetState extends State<SessionNotDowloadedWidget> {
  late SessionNotDowloadedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SessionNotDowloadedModel());
  }
              ...
              Stack(
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 275.0, 11.6, 0.0),
                      child: Container(
                        width: 48.0,
                        height: 36.0,
                        decoration: BoxDecoration(
